...
// import * as nv2 from "TimeSeries/lib/nv.d3";
import TimeSeriesChart from "./components/TimeSeriesChart";

export class TimeSeriesTimeSeriesChart extends _WidgetBase {
    ...
    private updateRendering (callback?: Function) {
        ...
        if (this.contextObj!==null) {
            ...
            ReactDOM.render(<TimeSeriesChart {...this.createProps() } />,this.domNode);
        }
...
export default TimeSeriesTimeSeriesChart;
